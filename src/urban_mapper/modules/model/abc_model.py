...
class ModelBase(ABC, BaseEstimator):
  ...
  def __extract_target(self, input_geodataframe: Union[gpd.GeoDataFrame, pd.DataFrame]) -> Tuple[Optional[Union[gpd.GeoDataFrame, pd.DataFrame, np.ndarray]], Optional[Union[pd.Series, np.ndarray]]]:  
    target = None
  ...
  def __extract_spatial_features(self, input_geodataframe: Union[gpd.GeoDataFrame, pd.DataFrame]) -> Tuple[Optional[Union[gpd.GeoDataFrame, pd.DataFrame, np.ndarray]], Optional[np.ndarray], Optional[gpd.GeoSeries]]:
  ...
  def __remove_target_outliers(self, input_geodataframe: Union[gpd.GeoDataFrame, pd.DataFrame], long_lat: Optional[np.ndarray], geometry: Optional[gpd.GeoSeries], target: Optional[pd.Series], fit: bool) -> Tuple[Optional[Union[gpd.GeoDataFrame, pd.DataFrame, np.ndarray]], Optional[np.ndarray], Optional[gpd.GeoSeries], Optional[Union[pd.Series, np.ndarray]]]:
  ...
  def __map_features(self, input_geodataframe: Union[gpd.GeoDataFrame, pd.DataFrame], fit: bool) -> Union[gpd.GeoDataFrame, pd.DataFrame]:  
  ...
  def __select_features(self, input_geodataframe: Union[gpd.GeoDataFrame, pd.DataFrame], fit: bool) -> Union[gpd.GeoDataFrame, pd.DataFrame]:  
  ...
  def __scale_features(self, input_geodataframe: Union[gpd.GeoDataFrame, pd.DataFrame], fit: bool) -> Union[gpd.GeoDataFrame, pd.DataFrame]:  
  ...
  def __train_val_test_split(self, input_geodataframe: Union[gpd.GeoDataFrame, pd.DataFrame]) -> Tuple[Union[gpd.GeoDataFrame, pd.DataFrame], Union[gpd.GeoDataFrame, pd.DataFrame], Union[gpd.GeoDataFrame, pd.DataFrame]]:
  ...
  def fit_predict(
    ...
    if (self.model is not None) and (isinstance(self.model, Pipeline) or not isinstance(self.model, (RegressorMixin, ClassifierMixin, ClusterMixin, str))):
      ...
      train, validation, test = self.__train_val_test_split(input_geodataframe)

      predicted_column = self.target_column + "_predicted"
      self.fit(input_geodataframe if train is None else train, validation=validation, **kwargs)
      predicted_value = self.predict(input_geodataframe if train is None else train, **kwargs)
